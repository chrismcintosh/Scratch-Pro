...
add_action( 'tgmpa_register', 'scratch_pro_register_required_plugins' );
/**
 ...
 */
function scratch_pro_register_required_plugins() {
	 ...
	 */
	$config = array(
		'domain'           => 'scratch_pro',              // Text domain - likely want to be the same as your theme.
		...
		'strings'          => array(
			'page_title'                      => __( 'Install Required Plugins', 'scratch_pro' ),
			'menu_title'                      => __( 'Install Plugins', 'scratch_pro' ),
			'installing'                      => _x( 'Installing Plugin: %s', '%1$s = plugin name', 'scratch_pro' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'scratch_pro' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'scratch_pro' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'scratch_pro' ),
			'complete'                        => _x( 'All plugins installed and activated successfully. %s', '%1$s = dashboard link', 'scratch_pro' ),
